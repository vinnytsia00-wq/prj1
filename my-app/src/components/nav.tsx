  ...
  return (
    <nav className="absolute w-full z-50 px-6 md:px-16 py-6 flex justify-between items-center">
      ...
      <div className="hidden md:flex items-center gap-10">
        <a href="/about-us" className="opacity-80 hover:opacity-100 transition">
          About Us
        </a>
        <a href="/product" className="opacity-80 hover:opacity-100 transition">
          Product
        </a>
        <a href="/platform" className="opacity-80 hover:opacity-100 transition">
          Platform
        </a>
        <a href="/solutions" className="opacity-80 hover:opacity-100 transition">
          Solutions
        </a> 
